...
export const getPostBySlug = async (slug, isPreview = false) => {
  const entries = await client(isPreview).getEntries({
    ...
    "fields.slug": slug,
    select:
      "fields.blogTitle,fields.blogTakeaways,fields.blogAuthor,fields.blogDescription,fields.blogRichTextParagraph,fields.blogImage,fields.blogCategory", // Only fetch the necessary fields
  });
